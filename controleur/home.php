        ...
        <div class="calendar-section">
            ...
            <div class="calendar-header">
                <div class="calendar-nav">
                    <a href="?page=1&mois=<?php echo $moisPrec; ?>&annee=<?php echo $anneePrec; ?>" class="btn-nav">◄ Précédent</a>
                    <a href="?page=1" class="btn-nav">Aujourd'hui</a>
                    <a href="?page=1&mois=<?php echo $moisSuiv; ?>&annee=<?php echo $anneeSuiv; ?>" class="btn-nav">Suivant ►</a>
                </div>
                ...
                for ($jour = 1; $jour <= $nbJours; $jour++) {
                    ...
                    if (isset($evenementsParJour[$jour])) {
                        foreach ($evenementsParJour[$jour] as $evt) {
                            ...
                            // Afficher prénom seulement si nom trop long, sinon nom + initiale prénom
                            $nom = isset($evt['nom_candidat']) ? $evt['nom_candidat'] : '';
                            $prenom = isset($evt['prenom_candidat']) ? $evt['prenom_candidat'] : '';
                            
                            if (strlen($nom) > 8) {
                                $affichage = $prenom; // Si nom long, afficher seulement le prénom
                            } else {
                                $affichage = $nom . ' ' . substr($prenom, 0, 1) . '.'; // Nom + initiale
                            }
